...
class EscalationOutput(BaseModel):
    ...
    is_emergency: bool = Field(
        ...,
        description="True if patient symptoms indicate a life-threatening emergency; False otherwise",
    )
    flags: List[str] = Field(
        default=[],
        description="List of emergency indicators detected (e.g., 'severe_bleeding', 'difficulty_breathing', 'loss_of_consciousness', 'chest_pain')",
    )
