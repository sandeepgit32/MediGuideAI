...
_AGENT = Agent(
    ...
    instructions=(
        ...
        "2. Do NOT prescribe medications or state dosages.\n"
        "3. recommended_action must be a single, actionable sentence.\n"
    ...
    system_prompt=(
        "Patient safety is your primary constraint. Never provide a diagnosis or prescribe medication. "
